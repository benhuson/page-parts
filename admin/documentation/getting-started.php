...
<div style="width: 65%;">
	...
	<div id="supported_post_types">
		...
		<p>If you need to add support for other post types or remove support for pages, use the <a href="<?php echo esc_url( add_query_arg( 'tab', 'examples' ) ); ?>#page_parts_supported_post_types"><code>page_parts_supported_post_types</code></a> filter.</p>
	...
	<div id="query_page_parts">
		...
		<p>To display page parts in a template, use WP_Query to get and <a href="<?php echo esc_url( add_query_arg( 'tab', 'templates' ) ); ?>#getting_a_page_part_template">loop through the page parts</a>.</p>
	...
	<div id="add_default_template">
		...
		<p>It is recommended to add a <a href="<?php echo esc_url( add_query_arg( 'tab', 'templates' ) ); ?>#default_page_part_template"><code>page-part.php</code></a> template in the root of your theme so that you can customize the appearance of page parts that do not have a custom template assigned.</p>
	...
	<div id="add_custom_templates">
		...
		<p>Define custom templates by adding a <a href="<?php echo esc_url( add_query_arg( 'tab', 'templates' ) ); ?>#define_a_custom_template"><code>Page Part Name:</code></a> docblock to the top of your page part template files.</p>
	...
	<div id="add_page_part_theme_locations">
		...
		<p>If you need to display page parts in multiple places in the same template, you can <a href="<?php echo esc_url( add_query_arg( 'tab', 'locations' ) ); ?>">define locations</a> to which you can assign page parts.</p>
	</div>

	<div id="further_customization">
		<h3>6. Further Customization <em>(optional)</em></h3>
		<p>View the documentation about <a href="<?php echo esc_url( add_query_arg( 'tab', 'filters' ) ); ?>">filters</a> and other <a href="<?php echo esc_url( add_query_arg( 'tab', 'examples' ) ); ?>">examples</a>.</p>
	</div>
